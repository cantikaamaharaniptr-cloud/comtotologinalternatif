...
const D = {
  brand: 'COMTOTO',
  domain: 'comtotologinalternatif.com',
  ...
  amphtml: 'comtotologinalternatif.com',
};
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>COMTOTO | Cara Masuk & Akses Aman: Zona Santai Penuh Kejutan</title>
        <meta name="description" content="COMTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href={D.logo} />
        <link rel="canonical" href={'https://' + D.domain + '/'} />
        <link rel="amphtml" href={'https://' + D.domain + '/amp/'} />
        <meta property="og:title" content="COMTOTO | Cara Masuk & Akses Aman: Zona Santai Penuh Kejutan" />
        <meta property="og:description" content="COMTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang." />
        <meta property="og:image" content={D.logo} />
        <meta property="og:url" content={'https://' + D.domain} />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="COMTOTO | Cara Masuk & Akses Aman: Zona Santai Penuh Kejutan" />
        <meta name="twitter:description" content="COMTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang." />
      ...
      <style jsx global>{`
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        body{font-family:'DM Sans',sans-serif;background:#2a0a18;color:#e0e0e0;line-height:1.7;overflow-x:hidden}
        a{color:inherit;text-decoration:none}img{max-width:100%;display:block}
        .W{max-width:1200px;margin:0 auto;padding:0 24px}

        .topbar{background:#3a1025;border-bottom:1px solid rgba(244,114,182,.25);padding:8px 0;font-size:12px;color:#ccc}
        .topbar-inner{display:flex;justify-content:space-between;align-items:center}
        .topbar a{color:#f472b6;font-weight:600;transition:.2s}.topbar a:hover{opacity:.8}

        header{background:#3a1025;border-bottom:1px solid rgba(244,114,182,.25);position:sticky;top:0;z-index:50;backdrop-filter:blur(12px)}
        .hd{display:flex;align-items:center;justify-content:space-between;padding:14px 0;gap:16px}
        .logo{display:flex;align-items:center;gap:10px;font-weight:800;font-size:22px;color:#f472b6;flex-shrink:0}
        .logo img{width:36px;height:36px;border-radius:10px;border:2px solid #f472b6}
        .search-bar{flex:1;max-width:480px;display:flex;border:1.5px solid rgba(244,114,182,.25);border-radius:10px;overflow:hidden;background:#4a1830}
        ...
        .search-bar button{background:#f472b6;color:#2a0a18;border:none;padding:0 18px;font-weight:700;cursor:pointer;font-family:inherit;font-size:13px;transition:.2s}
        .search-bar button:hover{background:#ec4899}
        ...
        .btn-p{background:#f472b6;color:#2a0a18}.btn-p:hover{background:#ec4899;transform:translateY(-1px)}
        .btn-o{border:1.5px solid rgba(244,114,182,.25);color:#f472b6;background:transparent}.btn-o:hover{background:rgba(244,114,182,.15)}

        .catnav{background:#4a1830;border-bottom:1px solid rgba(244,114,182,.25)}
        ...
        .catnav a:hover,.catnav a.act{color:#f472b6;border-bottom-color:#f472b6}

        .hero-banner{linear-gradient(135deg,#ec4899,#f472b6);padding:52px 0;position:relative;overflow:hidden}
        ...
        .hero-text .btn-w{background:#fff;color:#2a0a18;font-weight:700;padding:13px 28px;border-radius:10px;border:none;cursor:pointer;font-family:inherit;font-size:14px;transition:.25s}
        ...
        .stats{background:#3a1025;border-bottom:1px solid rgba(244,114,182,.25);padding:24px 0}
        .stats-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:16px;text-align:center}
        .stat-item{padding:8px 0}
        .stat-item .sv{font-size:26px;font-weight:800;color:#f472b6}
        .stat-item .sl{font-size:10px;color:#bbb;text-transform:uppercase;letter-spacing:1.5px;margin-top:2px}

        .sec{padding:52px 0}
        .sec-alt{background:#3a1025}
        .sec-head{text-align:center;margin-bottom:38px}
        .sec-head .label{display:inline-block;background:rgba(244,114,182,.15);color:#f472b6;padding:5px 16px;border-radius:8px;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;margin-bottom:12px;border:1px solid rgba(244,114,182,.25)}
        ...
        .art-content h3{font-size:20px;font-weight:700;margin-bottom:16px;color:#f472b6}
        ...
        .art-gallery img{border-radius:10px;border:1px solid rgba(244,114,182,.25);width:100%;height:200px;object-fit:cover;transition:.3s}
        .art-gallery img:hover{border-color:#f472b6;transform:scale(1.02)}
        .art-tags{display:flex;gap:8px;flex-wrap:wrap;margin-top:14px}
        .art-tag{background:rgba(244,114,182,.15);color:#f472b6;padding:5px 14px;border-radius:8px;font-size:11px;font-weight:600;border:1px solid rgba(244,114,182,.25)}

        .feat-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px}
        .feat-card{background:#4a1830;border:1px solid rgba(244,114,182,.25);border-radius:14px;padding:26px;transition:.3s}
        .feat-card:hover{border-color:#f472b6;transform:translateY(-4px);box-shadow:0 10px 30px rgba(0,0,0,.25)}
        .feat-card .fi-icon{width:48px;height:48px;border-radius:12px;background:rgba(244,114,182,.15);display:flex;align-items:center;justify-content:center;font-size:22px;margin-bottom:14px}
        ...
        .cta-box{linear-gradient(135deg,#ec4899,#f472b6);border-radius:18px;padding:52px 32px;text-align:center;color:#fff;position:relative;overflow:hidden}
        ...
        .cta-box .btn-w{background:#fff;color:#2a0a18;font-weight:700;padding:14px 34px;border-radius:10px;border:none;cursor:pointer;font-family:inherit;font-size:15px;transition:.25s}
        ...
        .bnr-card{border-radius:14px;overflow:hidden;border:1px solid rgba(244,114,182,.25);transition:.3s}
        .bnr-card:hover{transform:translateY(-3px);box-shadow:0 8px 24px rgba(0,0,0,.25);border-color:#f472b6}
        .bnr-card img{width:100%;height:auto}

        .faq-list{max-width:720px;margin:0 auto}
        .faq-item{background:#4a1830;border:1px solid rgba(244,114,182,.25);border-radius:12px;padding:18px 22px;margin-bottom:10px;cursor:pointer;transition:.2s}
        .faq-item:hover{border-color:#f472b6}
        .faq-q{font-weight:600;display:flex;justify-content:space-between;align-items:center;font-size:14px;color:#f0f0f0}
        .faq-q span{color:#f472b6;font-size:18px;font-weight:700}
        .faq-a{margin-top:12px;color:#bbb;font-size:13px;line-height:1.75;border-top:1px solid rgba(244,114,182,.25);padding-top:12px;text-align:justify}

        footer{background:#3a1025;border-top:1px solid rgba(244,114,182,.25);padding:36px 0;font-size:12px}
        .ft-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:30px;margin-bottom:24px}
        .ft-col h4{color:#f472b6;font-size:14px;margin-bottom:12px}
        .ft-col a{display:block;color:#aaa;margin-bottom:7px;transition:.2s}.ft-col a:hover{color:#f472b6}
        .ft-bottom{border-top:1px solid rgba(244,114,182,.25);padding-top:18px;text-align:center;color:#999}
      ...
      <main>
        <section className="hero-banner" style={{background:'linear-gradient(135deg,#ec4899,#f472b6)'}}><div className="W">
          <div className="hero-flex">
            <div className="hero-text">
              <div className="tag"><span className="dot"></span> {D.brand} Official</div>
              <h1>COMTOTO | Cara Masuk & Akses Aman: Zona Santai Penuh Kejutan</h1>
              <p>COMTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang.</p>
              <div className="hbtns">
        ...
        <section className="sec sec-alt" id="tentang"><div className="W">
          ...
          <div className="art-row">
            <div className="art-content">
              ...
              <p>COMTOTO melalui situs resmi COMTOTO tumbuh sebagai platform digital yang subur dan terpercaya. Seperti lahan pertanian yang terawat dengan baik, COMTOTO terus berkembang menghadirkan layanan login dan registrasi yang semakin mudah dan aman. Infrastruktur server kami ibarat tanah yang subur, memberikan fondasi kuat untuk pertumbuhan layanan yang berkelanjutan.</p>
              <div className="art-gallery">
              ...
              <p>Hasil panen terbaik dari COMTOTO di situs resmi COMTOTO adalah keamanan data berlapis SSL 256-bit, kecepatan akses premium dengan uptime 99,9%, dan ketersediaan link alternatif yang selalu segar. Tim support profesional kami bekerja seperti petani yang rajin, selalu siap 24 jam untuk memastikan ladang digital Anda tetap produktif dan bebas gangguan.</p>
